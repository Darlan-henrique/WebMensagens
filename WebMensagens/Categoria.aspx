<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="Categoria.aspx.cs" Inherits="WebMensagens.Categoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" GroupingText="Cadastro/Alteração de Categorias">
     ...
     <asp:Panel ID="Panel2" runat="server" GroupingText="Registros de Categorias">
